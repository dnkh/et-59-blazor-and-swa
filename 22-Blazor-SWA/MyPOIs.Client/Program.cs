...
builder.Services.AddHttpClient("MyPOIs.RemoteAPI", client => client.BaseAddress = string.IsNullOrEmpty(apiUri) ? new Uri(builder.HostEnvironment.BaseAddress) : new Uri(apiUri));
